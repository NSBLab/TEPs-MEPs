function [rescaled_allTEPs, rho, randPerm_rho, pVal] = fit_TepsMeps(pathIn, tepCond, mepCond, centChan, preStim, constrainTo, nI)
...
for idx = 1:length(ID)
    dataToExamin{idx} = mean(meanTrials{tepType}{idx}(j,:),1);
end
